...
GitHub repository: arbutuscollege-web-development
Directory: responsive_design
File: 01-styles.css, 01-index.html
Please review your task manually with the following checklist
Final rendering is the same as screenshot
...
Please review your task manually with the following checklist
Final rendering for narrow window same as the screenshot
...
Please review your task manually with the following checklist
Final rendering for narrow window (width < 767px) same as the screenshot
...
Please review your task manually with the following checklist
in 03-index.html, in the Latest News section, in the third img tag, there is a srcset of the same image in different resolutions (the images should be available in an images/ directory at the root of the project directory
...
Please review your task manually with the following checklist
in 05-styles.css, in the .header .menu-icon .navicon::after selector, top is -.7rem
...
Please review your task manually with the following checklist
Final rendering for small window (width < 480px) same as the screenshot
